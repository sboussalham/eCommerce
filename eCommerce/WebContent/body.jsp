...
<title>eCommerce | Formation Architecture des Composants
	d'Entreprise</title>
</head>
<body>
	...
	<b> <s:form action="addArticle">
			...
			<s:radio name="categorie" key="article.categorie"
				list="{'Categore 1','Categorie 2','Categorie 3'}" />
	...
	<s:else>
		...
		<table border="1">
			<tr>
				...
				<td><b><s:text name="article.suppr" /></b></td>
			</tr>
			<s:iterator value="articles">
				<tr>
					...
					<td><s:url name="del" value="del" />del</td>
				</tr>
			</s:iterator>
		</table>
	</s:else>
